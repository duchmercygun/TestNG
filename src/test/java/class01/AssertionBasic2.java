...
public class AssertionBasic2 {
    ...
    public void InvalidCredentials(){
        ...
        //finding the password element again as it's discarded when we clicked the logIn button because
        //the DOM refreshes
        password = driver.findElement(By.xpath("//input[@id = 'txtPassword']"));
        boolean displayedPassword=password.isDisplayed();
        Assert.assertTrue(displayedPassword);
